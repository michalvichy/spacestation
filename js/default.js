...
function showValue(val,slidernum,vertical) {
  ...
  var thumbsize = 12; /* must match the thumb size in your css */
  var bigval = 180; /* widest or tallest value depending on orientation */
  ...
  thumb.style.top =  (vertical ? loc : 2) + "px";
