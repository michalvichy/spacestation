...
update_option('current_page_template','Canvas Page');
									...
									while (have_posts()) : the_post(); ?>
										...
										<?php 
											...
											if (empty($_POST["selected_category"])){ 					
												...
												$category_form_value = $_POST["selected_category"]; 	
											}
										...
										<?php echo do_shortcode( '[portfolio_list_tuff 
											...
											lightbox="no" 
											view_button="no" 
											category="'.$category_form_value.'" 
											show_title="yes" title_tag="" 
											title_color="" 
											title_font_size="" 
											portfolio_separator="no" 
											separator_color="rgba(255,255,255,0.01)" 
											show_categories="yes" 
											category_color=""
											]' ); ?>
										<?php 
